...
public class InterviewServiceImpl implements InterviewService{
	 ...
	 * @return
	 */
	private CallResult<? extends List<QuestionResponse>> findOriginQuestionList(int interviewId,String questionaireCode) {
	 ...
	 * @return
	 */
	private CallResult<? extends List<QuestionResponse>> findEditorQuestionList(int interviewId, String questionaireCode) {
