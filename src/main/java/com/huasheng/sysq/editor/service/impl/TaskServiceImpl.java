...
public class TaskServiceImpl implements TaskService{
	...
	@Override
	public CallResult<Boolean> assignTask(final int userId, final String interviewIds) {
	...
	@Override
	public CallResult<Boolean> finishTask(final int taskId) {
	...
	@Override
	public CallResult<Boolean> enableQuestion(final int taskId, final String questionaireCode, final String questionCode , final String remark) {
	...
	@Override
	public CallResult<Boolean> disableQuestion(final int taskId, final String questionaireCode, final String questionCode,final String remark) {
	...
	@Override
	public CallResult<Boolean> editQuestion(final int taskId, final String questionaireCode, final String questionCode,final String results , final String remark) {
	...
	@Override
	public CallResult<Boolean> initTask(final int taskId) {
		LogUtils.info(this.getClass(), "initTask params : taskId = {}", taskId);
		try {
			//获取任务
			final Task task = taskDao.selectById(taskId);
			
			//获取访谈过的问卷
			final List<String> questionaireCodeList = sysqResultDao.getQuestionaireList(task.getInterviewId());
