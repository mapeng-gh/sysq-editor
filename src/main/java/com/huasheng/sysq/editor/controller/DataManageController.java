...
public class DataManageController {
	...
	@ResponseBody
	public CallResult<? extends List<QuestionResponse>> questionList(@RequestParam(value="versionId") int versionId , @RequestParam(value="questionaireCode") String questionaireCode) {
		LogUtils.info(this.getClass(), "questionList params : versionId = {},questionaireCode = {}",versionId,questionaireCode);
		
		//查询问题
		CallResult<? extends List<QuestionResponse>> result = dataService.getQuestionList(versionId, questionaireCode);
