(function(){
            ...
            <div class="task-manage-list">
                ...
                <div class="common-list">
                    <el-table
						...
						style="width: 100%">
						<el-table-column prop="task.id" label="任务编号" width="100" align="left" :show-overflow-tooltip="true"></el-table-column>
						<el-table-column prop="interview.id" label="访谈编号" align="left" :show-overflow-tooltip="true"></el-table-column>
						<el-table-column prop="interview.type" label="访谈类型" align="left" width="100" :show-overflow-tooltip="true">
						...
						<el-table-column prop="user.name" label="编辑人员" align="left" :show-overflow-tooltip="true"></el-table-column>
						...
						<el-table-column prop="task.status" label="任务状态" align="left" width="100" :show-overflow-tooltip="true">
							<template slot-scope="scope">
						...
						<el-table-column prop="operate" label="操作" align="left" width="100" :show-overflow-tooltip="true">
							<template slot-scope="scope">
	...
	window.taskManageListComponent = taskManageListComponent;
})();
