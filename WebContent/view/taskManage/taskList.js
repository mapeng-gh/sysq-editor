            ...
            <div class="task-manage-list">
                ...
                <div class="common-list">
                    <el-table
						...
						style="width: 100%">
						<el-table-column prop="task.id" label="任务编号" width="100" align="center" :show-overflow-tooltip="true"></el-table-column>
						<el-table-column prop="interview.id" label="访谈编号" align="center" :show-overflow-tooltip="true"></el-table-column>
						<el-table-column prop="interview.type" label="访谈类型" align="center" width="100" :show-overflow-tooltip="true">
							<template slot-scope="scope">
								{{$constants.INTERVIEW_TYPE.getInterviewTypeText(scope.row.interview.type)}}
							</template>
						</el-table-column>
						<el-table-column prop="interview.versionId" label="问卷版本" align="center" width="100" :show-overflow-tooltip="true"></el-table-column>
						...
						<el-table-column prop="task.status" label="任务状态" align="center" width="100" :show-overflow-tooltip="true">
							<template slot-scope="scope">
						...
						<el-table-column prop="operate" label="操作" align="center" width="100" :show-overflow-tooltip="true">
							<template slot-scope="scope">
